...
%%%%% Plot %%%%%
plot(perc*100, mean(mse_dwt),'r')
hold on
plot(perc*100, mean(mse_dct),'k')
plot(perc*100, mean(mse_dmt),'b')
plot(perc*100, mean(mse_klt),'m')
plot(perc*100, mean(mse_sot),'c')
grid on
legend('DWT', 'DCT','DMT','KLT','SOT')
